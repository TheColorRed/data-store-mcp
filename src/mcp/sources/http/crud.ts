 ...
 */
export class Crud<P extends BaseHttpPayload> extends HttpDataSource<P> {
  /**
   ...
   */
  #buildAndSendRequest(payload: P): Promise<string> {
   ...
   */
  mutation(request: ActionRequest<P>): Promise<string> {
    const payload = this.getPayloadObject(request);
    return this.#buildAndSendRequest(payload);
  }
  /**
   ...
   */
  insert(request: ActionRequest<P>): Promise<string> {
    const payload = this.getPayloadObject(request);
   ...
   */
  update(request: ActionRequest<P>): Promise<string> {
    const payload = this.getPayloadObject(request);
   ...
   */
  delete(request: ActionRequest<P>): Promise<string> {
    const payload = this.getPayloadObject(request);
   ...
   */
  showSchema(settings: ActionRequest<P>): Promise<unknown> {
    const payload = this.getPayloadObject(settings);
    return this.#buildAndSendRequest(payload);
  }
